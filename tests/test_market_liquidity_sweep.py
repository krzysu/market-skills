...
# -- regression: BUG-2026-06-24-01 (Pattern B Shape #1) ----------------------


class TestBugAbsentWithSubsRegression:
    """Regression for BUG-2026-06-24-01: 2 subs at wsum=0.35 should fire as DOUBLE_TEST.
    ...
    def test_two_subs_wsum_above_030_fires_double_test(self):
        ...
        assert result["pattern"]["present"] is True, (
            f"BUG-2026-06-24-01 regression: 2 subs (swing_taken+volume, wsum=0.35) "
