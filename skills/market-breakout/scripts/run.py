#!/usr/bin/env python3
"""market-breakout — L2 pattern detection: detects whether a breakout is real."""
...
def _help_lines(ticker: str) -> list[str]:
    return [
        f"Run `strategy-breakout-confirm {ticker} --json` for the L3 idea",
...
def main():
    ...
    print_header(f"BREAKOUT PATTERN — {ticker}")
    print(f"  {ticker}")
    print()
    print(
