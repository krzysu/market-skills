...
def analyze(candles, interval="1d", period="1y"):
    ...
    # ``ratio >= 0.4`` threshold silently dropped 2-sub cases at wsum in
    # (0.30, 0.40) — e.g. absorption + reaccumulation, sign_of_strength +
    # low_vol_after_distribution, absorption + low_vol_after_distribution
    # (each wsum 0.35). Same pattern as ALGO 4h (BUG-2026-06-24-01) and VVV
    # 4h trend-quality (BUG-2026-06-24-02).
